...
Since this uses the same <<reviewing,reviewer>> mechanism as `byFile()`, you can also configure a `script` or `ai` reviewer to show a diff tool or have an AI review the change before applying it.
