...
.Java
----
include::../../../test/java/examples/java/BasicsDocTest.java[tag=approval_test_annotation]
class MyTest {
  // ...
}
----
...
.Kotlin
----
include::../../../test/kotlin/examples/kotlin/BasicsDocTest.kt[tag=approval_test_annotation]
class MyTest {
  // ...
}
----
