...
HTTP approval testing follows the same <<printing,print>>, <<scrubbing,scrub>>, and <<approving,approve>> flow as any other value, with dedicated print formats and scrubbers for HTTP data.
