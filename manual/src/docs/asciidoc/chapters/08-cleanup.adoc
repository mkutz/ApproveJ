...
Instead of reviewing each failure individually, you can use the review-unapproved task/goal to open all unapproved files in the configured default <<reviewing,file reviewer>> at once.
...
The approve-all task/goal moves every received file to its corresponding approved file, replacing the previous content.
