...
.Java
----
include::../../../test/java/examples/java/BasicsDocTest.java[tag=approve_file_nextToTest_inSubdirectory]
----
[source,kotlin,indent=0,role="secondary"]
.Kotlin
----
include::../../../test/kotlin/examples/kotlin/BasicsDocTest.kt[tag=approve_file_nextToTest_inSubdirectory]
----
