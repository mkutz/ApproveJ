...
For nested or inner test classes, `<TestClass>` includes enclosing class names separated by dots (e.g. `OuterTest.InnerTest`).
...
See <<printing>> if you need a more sophisticated way of printing.
