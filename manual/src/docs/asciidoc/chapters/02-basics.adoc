...
To help you with that process, ApproveJ allows to configure a link:{javadoc-url}/core/org/approvej/review/FileReviewer.html[`FileReviewer`], which will trigger such a tool automatically (see <<configuration>>).
