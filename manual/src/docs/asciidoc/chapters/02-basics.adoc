...
Optionally you can configure the default behaviors of ApproveJ through multiple mechanisms.
...
3. User home properties file at `~/.config/approvej/approvej.properties`
4. Default values

This allows you to set global defaults in your home directory, override them per project, and further override them via environment variables (useful for CI/CD pipelines).
